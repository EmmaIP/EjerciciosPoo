...
public class DietProgram {
    ...
    private List<String> daysOfWeek;
        ...
        private void deleteFoodMenu(Diet diet) {  //para eliminar un alimento de una dieta concreta
            if (diet == null) {
        ...
        private void showDetailsMenu(Diet diet) {   //cambiar this-diet por parámetro
            if(diet!=null){
                System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
